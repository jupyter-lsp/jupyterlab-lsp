...
Bash
    ...
    ...    Bash
    ...    example.sh
    ...    Diagnostics=Failed to parse expression
...
CSS
    ...
    ...    CSS
    ...    example.css
    ...    Diagnostics=Do not use empty rulesets
...
Docker
    ...
    ...    Docker
    ...    Dockerfile
    ...    Diagnostics=Instructions should be written in uppercase letters
    ...    Jump to Definition=${def}
    ...    Rename=${def}
...
JS
    ...
    ...    JS
    ...    example.js
    ...    Diagnostics=Expression expected
    ...    Jump to Definition=${def}
    ...    Rename=${def}
...
Python (pyright)
    ...
    ...    Python
    ...    example.py
    ...    Diagnostics=is not defined (Pyright)
    ...    Jump to Definition=${def}
...
R
    ...
    ...    R
    ...    example.R
    ...    Diagnostics=Put spaces around all infix operators
    ...    Jump to Definition=${def}
...
TSX
    ...
    ...    TSX
    ...    example.tsx
    ...    Diagnostics='hello' is declared but its value is never read.
    ...    Jump to Definition=${def}
    ...    Rename=${def}
...
TypeScript
    ...
    ...    TypeScript
    ...    example.ts
    ...    Diagnostics=The left-hand side of an arithmetic
    ...    Jump to Definition=${def}
    ...    Rename=${def}
