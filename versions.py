...
JUPYTERLAB_PYTHON_VERSION = (
    JUPYTERLAB_VERSION
    .replace('-alpha.', 'a')
    .replace('-beta.', 'b')
    .replace('-rc.', 'rc')
)
JUPYTERLAB_NEXT_MAJOR_VERSION = int(JUPYTERLAB_PYTHON_VERSION.split('.')[0]) + 1
REQUIRED_JUPYTERLAB = (
    f'>={JUPYTERLAB_PYTHON_VERSION},<{JUPYTERLAB_NEXT_MAJOR_VERSION}.0.0a0'
)
REQUIRED_JUPYTER_SERVER = '>=1.1.2'
REQUIRED_PYTHON = '>=3.10,<3.13.0a0'
